...
```
docker exec -it spark-streaming-pipeline-redis-1 redis-cli
```
...
```
docker exec -it spark-streaming-pipeline-kafka-1 kafka-console-consumer --bootstrap-server localhost:9092 --topic redis-server
```
...
```
docker logs spark-streaming-pipeline-spark-1 >& ../../spark/logs/spark-master.log

docker logs spark-streaming-pipeline-spark-1 >& ../../spark/logs/spark-master.log >& ../../spark/logs/spark-worker.log
```
...
```
docker logs -f spark-streaming-pipeline-stedi-1
```
